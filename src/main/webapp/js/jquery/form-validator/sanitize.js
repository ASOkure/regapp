...
!function (a, b) {
  ...
  var c = '[type="button"], [type="submit"], [type="radio"], [type="checkbox"], [type="reset"], [type="search"]', d = {
    upper: function (a) {
      ...
      if (!("numeral" in b))throw new Error('Using sanitation function "numberFormat" requires that you include numeraljs (http://http://numeraljs.com/)');
      return a = numeral(a).format(c.attr("data-sanitize-number-format"))
    }, strip: function (b, c) {
      var d = c.attr("data-sanitize-strip") || "";
      return a.split(d, function (a) {
    ...
    e.each(function () {
      ...
      }), b.find("[data-sanitize]").unbind("blur.sanitation", g).bind("blur.sanitation", g), a(function () {
