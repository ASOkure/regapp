...
!function (a, b) {
  ...
  a.formUtils.addValidator({
    ...
    name: "confirmation", validatorFunction: function (a, b, c, d, e) {
      var f = "", g = b.valAttr("confirm") || b.attr("name") + "_confirmation", h = e.find('[name="' + g + '"]').eq(0);
      if (h) {
        if (f = h.val(), c.validateOnBlur && !h[0].hasValidationCallback) {
          h[0].hasValidationCallback = !0;
          var i = function () {
            b.validate()
          };
          h.on("keyup", i), e.one("formValidationSetup", function () {
            h[0].hasValidationCallback = !1, h.off("keyup", i)
          })
        }
  ...
  a.formUtils.addValidator({
    name: "creditcard", validatorFunction: function (f, g) {
      ...
      return a.each(f.split("").reverse(), function (a, b) {
        b = parseInt(b, 10), a % 2 === 0 ? j += b : (b *= 2, j += 10 > b ? b : b - 9)
      }), j % 10 === 0
    ...
    name: "strength", validatorFunction: function (b, c) {
      ...
      var d = {fontSize: "12pt", padding: "4px", bad: "Very Weak", weak: "Weak", good: "Good", strong: "Strong"};
  ...
  a.formUtils.addValidator({
    name: "server", validatorFunction: function (b, c, d, e, h) {
      ...
      return c.valAttr("url") ? k = c.valAttr("url") : "serverURL" in d && (k = d.backendUrl), i ? !0 : j ? !1 : "keyup" === a.formUtils.eventType ? null : a.formUtils.isValidatingEntireForm ? (h.bind("submit", g).addClass("validating-server-side").addClass("on-blur"), c.addClass("validating-server-side"), a.formUtils.haltValidation = !0, f(k, c, b, d, function () {
