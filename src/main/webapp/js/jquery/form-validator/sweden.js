...
!function (a, b) {
  a.formUtils.addValidator({
    name: "swesec", validatorFunction: function (c, d) {
      var e, f, g, h;
      ...
      e = RegExp.$1, f = a.formUtils.parseDateInt(RegExp.$2), g = a.formUtils.parseDateInt(RegExp.$3), b.ssnGender = parseInt(RegExp.$4.substring(2, 3)) % 2 === 0 ? "female" : "male";
      var i = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
      if ((e % 400 === 0 || e % 4 === 0 && e % 100 !== 0) && (i[1] = 29), 1 > f || f > 12 || 1 > g || g > i[f - 1])return !1;
      c = c.substring(2, c.length);
      for (var j = "", k = 0; k < c.length; k++)j += ((k + 1) % 2 + 1) * c.substring(k, k + 1);
      var l = 0;
      for (k = 0; k < j.length; k++)l += parseInt(j.substring(k, k + 1), 10);
      return l % 10 === 0
    }, errorMessage: "", errorMessageKey: "badSecurityNumber"
  }), a.formUtils.addValidator({
    name: "swecounty",
    validatorFunction: function (b) {
      return b = b.toLowerCase(), -1 === a.inArray(b, this.counties) ? "län" !== b.substr(-3).toLocaleLowerCase() ? a.inArray(b + "s län", this.counties) > -1 : !1 : !0
    },
    errorMessage: "",
    errorMessageKey: "badCustomVal",
    counties: ["stockholms län", "uppsala län", "södermanlands län", "östergötlands län", "jönköpings län", "kronobergs län", "kalmar län", "gotlands län", "blekinge län", "skåne län", "hallands län", "västra götalands län", "värmlands län", "örebro län", "västmanlands län", "dalarnas län", "gävleborgs län", "västernorrlands län", "jämtlands län", "västerbottens län", "norrbottens län"]
  }), a.formUtils.addValidator({
    name: "swemunicipality",
    validatorFunction: function (b) {
      return b = b.toLowerCase(), -1 === a.inArray(b, this.municipalities) ? "s kommun" === b.substr(-8) && a.inArray(b.substr(0, b.length - 8), this.municipalities) > -1 ? !0 : " kommun" === b.substr(-7) ? a.inArray(b.substr(0, b.length - 7), this.municipalities) > -1 : !1 : !0
    },
    errorMessage: "",
    errorMessageKey: "badCustomVal",
    ...
    name: "swephone", validatorFunction: function (a) {
      var b = a.match(/\+/g), c = a.match(/-/g);
      return null !== b && b.length > 1 || null !== c && c.length > 1 ? !1 : null !== b && 0 !== a.indexOf("+") ? !1 : (a = a.replace(/([-|\+])/g, ""), a.length > 8 && null === a.match(/[^0-9]/g))
    }, errorMessage: "", errorMessageKey: "badTelephone"
  }), a.formUtils.addValidator({
    name: "swemobile", validatorFunction: function (b) {
      if (!a.formUtils.validators.validate_swephone.validatorFunction(b))return !1;
      b = b.replace(/[^0-9]/g, "");
      var c = b.substring(0, 3);
      return 10 !== b.length && "467" !== c ? !1 : 11 !== b.length && "467" === c ? !1 : /07[0-9{1}]/.test(c) || "467" === c
    }, errorMessage: "", errorMessageKey: "badTelephone"
  });
  var c = function (b) {
    var c = [];
  ...
  a.fn.suggestSwedishCounty = function (b) {
    ...
    var d = c(a.formUtils.validators.validate_swemunicipality.municipalities);
    return a.formUtils.suggest(this, d, b)
  }
}(jQuery, window);