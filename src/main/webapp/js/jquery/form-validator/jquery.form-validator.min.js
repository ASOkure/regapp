...
!function (a, b) {
  ...
  a.formUtils = a.extend(a.formUtils || {}, {
    ...
    isLoadingModules: !1,
    loadedModules: {},
    loadModules: function (b, d, e) {
      if (void 0 === e && (e = !0), a.formUtils.isLoadingModules)return void setTimeout(function () {
        a.formUtils.loadModules(b, d, e)
      });
      var f = !1, g = function (b, d) {
        var g = a.split(b), h = g.length, i = function () {
          h--, 0 === h && (a.formUtils.isLoadingModules = !1, e && f && ("function" == typeof e ? e() : c.trigger("validatorsLoaded")))
        };
        h > 0 && (a.formUtils.isLoadingModules = !0);
        var j = "?_=" + (new Date).getTime(), k = document.getElementsByTagName("head")[0] || document.getElementsByTagName("body")[0];
        a.each(g, function (b, c) {
          if (c = a.trim(c), 0 === c.length)i(); else {
            var e = d + c + (".js" === c.slice(-3) ? "" : ".js"), g = document.createElement("SCRIPT");
            e in a.formUtils.loadedModules ? i() : (a.formUtils.loadedModules[e] = 1, f = !0, g.type = "text/javascript", g.onload = i, g.src = e + (".dev.js" === e.slice(-7) ? j : ""), g.onerror = function () {
              a.formUtils.warn("Unable to load form validation module " + e)
    ...
    validateInput: function (b, c, d, e, f) {
      ...
      return r && a.each(r.split(""), function (a, b) {
        ...
        var j = null;
        return ("keyup" !== f || i.validateOnKeyUp) && (j = i.validatorFunction(g, b, d, c, e)), j ? void 0 : (q = null, null !== j && (q = b.attr(d.validationErrorMsgAttribute + "-" + h.replace("validate_", "")), q || (q = b.attr(d.validationErrorMsgAttribute), q || (q = "function" != typeof i.errorMessageKey ? c[i.errorMessageKey] : c[i.errorMessageKey(d)], q || (q = i.errorMessage)))), !1)
      }, " "), "string" == typeof q ? (b.trigger("validation", !1), h.errorMsg = q, h.isValid = !1, h.shouldChangeDisplay = !0) : null === q ? h.shouldChangeDisplay = d.addValidClassOnAll : (b.trigger("validation", !0), h.shouldChangeDisplay = !0), "function" == typeof d.onElementValidate && null !== q && d.onElementValidate(h.isValid, b, e, q), h
    },
  ...
  a.split = function (b, c) {
    ...
    a(b.form).each(function (c, d) {
      ...
      var e = a(d);
      a.formUtils.$win.trigger("formValidationSetup", [e, b]), e.trigger("formValidationSetup", [b]), e.find(".has-help-txt").unbind("focus.validation").unbind("blur.validation"), e.removeClass("has-validation-callback").unbind("submit.validation").unbind("reset.validation").find("input[data-validation],textarea[data-validation]").unbind("blur.validation"), e.bind("submit.validation", function () {
        var c = a(this);
        ...
        var d = c.isValid(b.language, b);
        if (a.formUtils.haltValidation)return !1;
        if (!d || "function" != typeof b.onSuccess)return d || "function" != typeof b.onError ? d : (b.onError(c), !1);
        var e = b.onSuccess(c);
        return e === !1 ? !1 : void 0
      }).bind("reset.validation", function () {
        var c = a(this), d = c.find("." + b.errorElementClass + ",.valid");
        c.find("." + b.errorMessageClass + ".alert").remove(), a.formUtils.errorDialogs.removeErrorStyling(d, b)
      ...
      "function" == typeof b.onModulesLoaded && b.onModulesLoaded(), a.formUtils.$win.trigger("validatorsLoaded", ["string" == typeof b.form ? a(b.form) : b.form, b])
    })
  }
}(jQuery), function (a) {
  "use strict";
    ...
    loadModules: function (b, c, d) {
      ...
      var e = !1, f = function (b, c) {
        var f = a.split(b), g = f.length, h = function () {
          g--, 0 === g && (a.formUtils.isLoadingModules = !1, d && e && ("function" == typeof d ? d() : a.formUtils.$win.trigger("validatorsLoaded")))
        };
  ...
  a.fn.validateOnBlur = function (b, c) {
  ...
  }, a.fn.showHelpOnFocus = function (c) {
    return c || (c = "data-validation-help"), this.find(".has-help-txt").valAttr("has-keyup-event", !1).removeClass("has-help-txt"), this.find("textarea,input").each(function () {
      var d = a(this), e = "jquery_form_help_" + ++b, f = d.attr(c);
      f && d.addClass("has-help-txt").unbind("focus.help").bind("focus.help", function () {
        var b = d.parent().find("." + e);
        0 === b.length && (b = a("<span />").addClass(e).addClass("help").addClass("help-block").text(f).hide(), d.after(b)), b.fadeIn()
  ...
  }, a.fn.validateInputOnBlur = function (b, c, d, e) {
    if (a.formUtils.eventType = e, this.willPostponeValidation()) {
      var f = this, g = this.valAttr("postpone") || 200;
      return window.postponedValidation = function () {
        f.validateInputOnBlur(b, c, d, e), window.postponedValidation = !1
      }, setTimeout(function () {
        window.postponedValidation && window.postponedValidation()
      }, g), this
    }
    b = a.extend({}, a.formUtils.LANG, b || {}), a.formUtils.errorDialogs.removeErrorStyling(this, c);
    var h = this, i = h.closest("form"), j = a.formUtils.validateInput(h, b, c, i, e);
    return d && h.unbind("keyup.validation"), j.isValid ? j.shouldChangeDisplay && (h.addClass("valid"), a.formUtils.errorDialogs.getParentContainer(h).addClass(c.inputParentClassOnSuccess)) : j.isValid || (a.formUtils.errorDialogs.applyErrorStyling(h, c), a.formUtils.errorDialogs.setInlineErrorMessage(h, j.errorMsg, c, c.errorMessagePosition), d && h.bind("keyup.validation", function (d) {
      9 !== d.keyCode && a(this).validateInputOnBlur(b, c, !1, "keyup")
    })), this
  }, a.fn.valAttr = function (a, b) {
    return void 0 === b ? this.attr("data-validation-" + a) : b === !1 || null === b ? this.removeAttr("data-validation-" + a) : (a = a.length > 0 ? "-" + a : "", this.attr("data-validation" + a, b))
    ...
    var f = function (b, e) {
      a.inArray(b, h) < 0 && h.push(b), i.push(e), e.attr("current-error", b), d && a.formUtils.errorDialogs.applyErrorStyling(e, c)
    }, g = [], h = [], i = [], j = this, k = function (b, d) {
      return "submit" === d || "button" === d || "reset" === d ? !0 : a.inArray(b, c.ignore || []) > -1
    };
    if (d && (j.find("." + c.errorMessageClass + ".alert").remove(), a.formUtils.errorDialogs.removeErrorStyling(j.find("." + c.errorElementClass + ",.valid"), c)), j.find("input,textarea,select").filter(':not([type="submit"],[type="button"])').each(function () {
          ...
          if (!k(i, e) && (!h || a.inArray(i, g) < 0)) {
            ...
            l.shouldChangeDisplay && (l.isValid ? l.isValid && (d.valAttr("current-error", !1).addClass("valid"), a.formUtils.errorDialogs.getParentContainer(d).addClass(c.inputParentClassOnSuccess)) : f(l.errorMsg, d))
          }
    ...
    return a.formUtils.isValidatingEntireForm = !1, !a.formUtils.haltValidation && i.length > 0 ? (d && ("top" === c.errorMessagePosition ? a.formUtils.errorDialogs.setTemplateMessage(j, b.errorTitle, h, c) : "custom" === c.errorMessagePosition ? (_warn("Use deprecated function errorMessageCustom"), "function" == typeof c.errorMessageCustom && c.errorMessageCustom(j, b.errorTitle, h, c)) : a.each(i, function (b, d) {
      a.formUtils.errorDialogs.setInlineErrorMessage(d, d.attr("current-error"), c, c.errorMessagePosition)
  ...
  var b = {
    getParentContainer: function (b) {
      ...
      return c
    }, applyErrorStyling: function (a, b) {
    ...
    }, removeErrorStyling: function (c, d) {
      c.each(function () {
        var c = a(this);
        b.setInlineErrorMessage(c, "", d, d.errorMessagePosition), c.removeClass("valid").removeClass(d.errorElementClass).css("border-color", ""), b.getParentContainer(c).removeClass(d.inputParentClassOnError).removeClass(d.inputParentClassOnSuccess).find("." + d.errorMessageClass).remove()
      })
    }, setInlineErrorMessage: function (b, c, d, e) {
      var f = document.getElementById(b.attr("name") + "_err_msg"), g = function (d) {
        a.formUtils.$win.trigger("validationErrorDisplay", [b, d]), d.html(c)
      }, h = {};
      if (f ? (a.formUtils.warn("Using deprecated element reference " + f.id), e = a(f)) : "function" == typeof e && (e = e(b, c, d)), "object" == typeof e) {
        var i = !1;
        e.find("." + d.errorMessageClass).each(function () {
          return this.inputReferer === b[0] ? (i = a(this), !1) : void 0
        }), i ? c ? g(i) : i.remove() : (h = a('<div class="' + d.errorMessageClass + '"></div>'), g(h), h[0].inputReferer = b[0], e.prepend(h))
      } else {
        var j = this.getParentContainer(b);
        h = j.find("." + d.errorMessageClass + ".help-block"), 0 === h.length && (h = a("<span></span>").addClass("help-block").addClass(d.errorMessageClass), h.appendTo(j)), g(h)
      }
    }, setTemplateMessage: function (b, c, d, e) {
  ...
  a.formUtils = a.extend(a.formUtils || {}, {errorDialogs: b})
}(jQuery), function (a) {
  a.formUtils.addValidator({
    ...
    name: "phone", validatorFunction: function (b) {
      var c = new RegExp("^((\\+)|(0{2}))?(\\d{2}|\\d{3})-?\\s?(\\d{3})-?\\s?(\\d{3})-?\\s?(\\d{3,4})$");
      return c.test(b)
    }, errorMessage: "", errorMessageKey: "badPhoneNumber"
  }), a.formUtils.addValidator({
