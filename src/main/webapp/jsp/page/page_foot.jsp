...
<div id="page-foot" class="page-foot">
  ...
  <div class="page-foot-middle">
    ...
    <img height="33" alt="Google Chrome" src="<%=path %>/images/browsers/google-chrome.jpg"/>
    <img height="36" alt="Firefox" src="<%=path %>/images/browsers/firefox.jpg"/>
    <img height="40" alt="Safari" src="<%=path %>/images/browsers/safari.jpg"/>
  </div>
