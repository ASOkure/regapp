...
<script type="text/javascript">
  YUI().use("node", function (Y) {
    Y.on("domready", edit_gene_analysis_init);
  })
</script>

<h1>Update Record: Register ID <s:property value="registerId"/> - Genetic Analysis</h1>
<s:include value="tabs.jsp"/><br/>
...
<s:form id="edit_form_3" action="save_gene_analysis" theme="simple">
  ...
  <tr class="gene_secondary_table_tr">
    ...
    <td class="gene_secondary_table_td_right" colspan="2">
      ...
      <div id="screened_gene_edit_button_div" class="screened_gene_edit_button_class">
        <br/>
          ...
          <s:iterator value="dsdGeneScreeneds" status="screens">
            <tr id="gene_selection_tr_<s:property value="gene.geneId"/>">
              <td id="gene_selection_gene_td_<s:property value="gene.geneId"/>" class="tertiary_table_td_desc">
                ...
                <s:hidden id="%{'sequence_gene_id_' + gene.geneId}" name="dsdGeneScreeneds[%{#screens.index}].gene.geneId" value="%{gene.geneId}"></s:hidden>
                <s:hidden id="%{'screen_id_' + screenId}" name="dsdGeneScreeneds[%{#screens.index}].screenId" value="%{screenId}"></s:hidden>
              </td>
              <td id="gene_selection_sequence_td_<s:property value="gene.geneId"/>">
                <s:select id="sequence_select_%{gene.geneId}" name="dsdGeneScreeneds[%{#screens.index}].directSequence" list="yesNoOptions" listKey="value" listValue="value"
                          emptyOption="false" headerKey="" headerValue="- Select -" cssClass="gene_sequence_select"></s:select>
                ...
                <div id="sequence_text_<s:property value="gene.geneId"/>_div" class="div_shown">
                  ...
                  <div id="sequence_text_<s:property value="gene.geneId"/>_div" class="div_hidden">
                    ...
                    <s:textarea id="sequence_text_%{gene.geneId}" rows="2" cols="20" name="dsdGeneScreeneds[%{#screens.index}].otherSequence" cssClass="gene_sequence_text"></s:textarea>
                  </div>
              </td>
              <td id="gene_selection_mutation_td_<s:property value="gene.geneId"/>">
                <s:checkbox id="gene_mutation_checkbox_%{gene.geneId}" name="dsdGeneScreeneds[%{#screens.index}].mutationFound" cssClass="gene_mutation_checkbox"></s:checkbox>
                ...
                <div id="mutation_detail_<s:property value="gene.geneId"/>_div" class="div_shown">
                  ...
                  <div id="mutation_detail_<s:property value="gene.geneId"/>_div" class="div_hidden">
                    ...
                    <s:textarea id="mutation_text_%{gene.geneId}" rows="2" cols="20" name="dsdGeneScreeneds[%{#screens.index}].mutationDetail" cssClass="gene_mutation_text"></s:textarea>
                  </div>
              </td>
            </tr>
          </s:iterator>
