...
<div id="search-record-div">
  ...
  <s:form id="search_form" action="search_request_submit" theme="simple" cssClass='required-validate'>
            ...
            <table class="section-table-bottom"></s:if>
              ...
              <table class="section-table"></s:else>
                ...
                <tr>
                  <td colspan="3">
                    <h3>
                      <s:checkbox id="%{'section_check_' + sectionId}" name="%{'section_check_' + sectionId}" value="false"/>
                ...
                <s:iterator value="parameters" id="para" status="paras">
                  ...
                  <td class="parameter-checkbox-td">
                    <s:if test="#sec.sectionId == 6 && #sec.name.startsWith('First ')">
                      <s:checkbox id="%{'first_parameter_checkbox_' + paramId}" name="dsdSearchCriteria.selectedParameterIds" value="false" fieldValue="%{paramId + 'f'}"/>
                    </s:if>
                    <s:elseif test="#sec.sectionId == 6 && #sec.name.startsWith('Latest ')">
                      <s:checkbox id="%{'last_parameter_checkbox_' + paramId}" name="dsdSearchCriteria.selectedParameterIds" value="false" fieldValue="%{paramId + 'l'}"/>
                    </s:elseif>
                    <s:else>
                      <s:checkbox id="%{'parameter_checkbox_' + paramId}" name="dsdSearchCriteria.selectedParameterIds" value="false" fieldValue="%{paramId}"/>
                    </s:else>
                  </td>
                  ...
                  <td class="parameter-value-search">
                    ...
                    <s:if test="type == 'double_menu'">
                      <s:if test="paramId == 2">
                        <s:doubleselect name="%{paramName}" headerKey="" headerValue="--- Please Select ---" list="countries" listKey="countryName" listValue="countryName" doubleName="%{'dsdIdentifier.' + menu.tertiaryParamName}" doubleHeaderKey="" doubleHeaderValue="--- Please Select ---" doubleList="centres" doubleListKey="centreName" doubleListValue="centreName" cssClass='validate-selection'/>
                      </s:if>
                      <s:else>
                        <s:doubleselect name="%{paramName}" headerKey="" headerValue="--- Please Select ---" list="menu.options" listKey="value" listValue="value" doubleName="%{'dsdIdentifier.' + menu.tertiaryParamName}" doubleHeaderKey="" doubleHeaderValue="--- Please Select ---" doubleList="tertiaries" doubleListKey="value" doubleListValue="value" cssClass='validate-selection'/>
                      </s:else>
                    </s:if>
                    ...
                    <s:if test="type == 'auto_fill'">
                      <s:if test="paramId == 33">
                        <s:textfield name="%{paramName}" cssClass="float-range-0-12"/>
                      </s:if>
                    ...
                    <s:if test="type == 'float'">
                      ...
                      <s:if test="paramId == 25">
                        <s:textfield name="%{paramName}" cssClass="float-range-0-200"/>
                  ...
                  <s:if test="paramId == 47">
                    <tr>
                      ...
                      <td class="parameter-value-search">
                        ...
                        <s:textarea id="selected_gene" name="dsdSearchCriteria.selectedGeneNames" cssClass="gene-search-selection" readonly="true"/>
                      </td>
                    </tr>
                  </s:if>
                </s:iterator>
                  ...
                  <table>
                    <tr>
                      ...
                      <td>
                        ...
                        <s:select name="dsdSearchCriteria.consent" list="consentLevelMap" listKey="key" listValue="value" emptyOption="false" headerKey="" headerValue="------ Please Select Consent Level------" cssClass='validate-selection'/>
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 20px;">
                        <s:checkbox name="dsdSearchCriteria.sampleConsent"/>
                      </td>
                      <td>
              ...
              <tr>
                <td colspan="3" align="right">
                  <s:submit value="Request" theme="simple"></s:submit>
