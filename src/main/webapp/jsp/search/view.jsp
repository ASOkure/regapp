...
<div id="search-record-div">
  ...
  <s:form id="search_form" action="search" theme="simple" cssClass='required-validate'>
                ...
                <s:iterator value="parameters" id="para" status="paras">
                  ...
                  <td class="parameter-value-search">
                    ...
                    <s:if test="type == 'double_menu'">
                      <s:if test="paramId == 2">
                        <s:doubleselect name="%{paramName}" headerKey="" headerValue="--- Please Select ---" list="countries" listKey="countryName" listValue="countryName" doubleName="%{'dsdIdentifier.' + menu.tertiaryParamName}" doubleHeaderKey="" doubleHeaderValue="--- Please Select ---" doubleList="centres" doubleListKey="centreName" doubleListValue="centreName" theme="simple" cssClass='validate-selection'/>
                      </s:if>
                      <s:else>
