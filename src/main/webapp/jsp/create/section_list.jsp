...
<p>
  Case <b><s:property value="%{#parameters.registerId}"/></b>
  has been created successfully. Please <u>take a note</u> of this register ID for future reference to this case!
</p>

<p>
  To enter data for other sections, please click on below links:
<ul>
  <li>
