...
<html>
  <head>
    ...
    <%--<link type="text/css" rel="stylesheet" href="js/jquery/te_140/demo.css">--%>
    <link type="text/css" rel="stylesheet" href="js/jquery/te_140/jquery-te-1.4.0.css">

    <script type="text/javascript" src="http://code.jquery.com/jquery.min.js" charset="utf-8"></script>
    <script type="text/javascript" src="js/jquery/te_140/jquery-te-1.4.0.min.js" charset="utf-8"></script>
  </head>
