...
/* ********  P R I V A T E   F I E L D S  ******** */
    ...
    static {
        ...
        try {
            ...
            log.error("Error while getting bytes for alphabet", use);
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options) {
        ...
        try {
            ...
            log.error("Error while creating a new String from ByteArray with default encoding: " + PREFERRED_ENCODING, uue);
    ...
    public static String encodeBytes(byte[] source, int off, int len, int options) {
        ...
        if (gzip == GZIP) {
            ...
            try {
                ...
                log.error("Error while creating new String from byte array with default encoding " + PREFERRED_ENCODING, uue);
                return new String(baos.toByteArray());
            }   // end catch
        }   // end if: compress
        ...
        // Else, don't compress. Better not to use streams at all then.
            ...
            try {
                ...
                log.error("Error while creating new String from buffer with default encoding: " + PREFERRED_ENCODING, uue);
