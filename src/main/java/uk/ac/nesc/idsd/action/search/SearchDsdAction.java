...
public class SearchDsdAction extends AbstractAction {
    ...
    public String searchView() {
        ...
        try {
            if (Authorization.isContributor(portalUser) || Authorization.isAuditor(portalUser) || Authorization.isSuperUser(portalUser)) {
                sections = parameterService.getAllSearchSections(portalUser);
            } else {
                sections = parameterService.getCoreSearchSections(portalUser);
